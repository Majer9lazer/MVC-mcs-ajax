...
namespace MVC_mcs_Ajax.DAL
{
    ...
    public partial class newEquipment
    {
        ...
        public newEquipment()
        {
            this.TrackMeters = new HashSet<TrackMeter>();
            this.TrackServiceHistories = new HashSet<TrackServiceHistory>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<TrackServiceHistory> TrackServiceHistories { get; set; }
    }
}
